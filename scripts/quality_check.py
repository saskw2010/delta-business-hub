...
REQUIRED = {'index.html','ideas.html','submit.html','community.html','about.html','404.html','assets/css/styles.css','assets/js/app.js','data/ideas.json'}
...
for page in HTML_FILES:
    ...
    for link in parser.links:
        ...
        except ValueError: errors.append(f'{page.name}: unsafe path {link}'); continue
        if not target.exists(): errors.append(f'{page.name}: broken local reference {link}')
